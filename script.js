document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Bone Paths Toggle ---
    const bonePathsToggle = document.getElementById('bone-paths-toggle');
    const bonePathsContent = document.getElementById('bone-paths-content');
    
    if (bonePathsToggle && bonePathsContent) {
        bonePathsToggle.addEventListener('click', () => {
            const isHidden = bonePathsContent.style.display === 'none';
            bonePathsContent.style.display = isHidden ? 'block' : 'none';
        });
    }
});